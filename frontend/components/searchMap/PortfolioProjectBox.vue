...
import MapProjectsBox from '@/components/common/map/MapProjectsBox'
  ...
  computed: {
    ...mapGetters({
      ...
      currentSubNationalProjects:
        'search/getSelectedCountryCurrentSubLevelProjects',
      filteredProjects: 'search/getActiveTabProjects',
