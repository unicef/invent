...
describe('Add member as a Team Member on a New Initiative', () => {
    it('https://unicef.visualstudio.com/ICTD-INVENT/_workitems/edit/159936/',() => {
        ...
        initiativePage.typeTeamMembersField(Cypress.env('validusername'))
        initiativePage.getTeamMembersField().should('contain', (Cypress.env('validusername'))).and('contain', (Cypress.env('noportfolio')))
    })
})  