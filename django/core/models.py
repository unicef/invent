...
from ordered_model.models import OrderedModelManager, OrderedModelManager, OrderedModelQuerySet
...
class GetObjectOrNoneManager(OrderedModelManager, models.Manager):
    def get_queryset(self):
        return GetObjectOrNoneQueryset(self.model, using=self._db)
...
class ActiveOrderedQuerySet(GetObjectOrNoneMixin, OrderedModelQuerySet):
    pass


class ActiveManager(OrderedModelManager):
    def get_queryset(self):
        return ActiveOrderedQuerySet(self.model, using=self._db)


class ActiveQuerySet(GetObjectOrNoneMixin, QuerySet):
    def __init__(self, model=None, *args, **kwargs):
        super(ActiveQuerySet, self).__init__(model, *args, **kwargs)
