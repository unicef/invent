...
REVIEWER_QUESTIONS = [
    {'ref_id': 'psa',
     ...
     'text': _('Which problem statement(s) (if any) does this project address across the relevant portfolio(s)?'),
    ...
    {'ref_id': 'ratp',
     ...
     'guidance': _('1 – This initiative does not address UNICEF’s equity agenda at all\n3 – This initiative somewhat '
    ...
    {'ref_id': 'ra',
     ...
     'text': _('What are the perceived risk levels associated with the project/ initiative? This could be in terms of '
               'e.g. personnel, reputational, financial and data privacy risks.'),
     'guidance': _('1 – no major risks identified\n3 – risks identified, but appropriate mitigations are in place\n'
    ...
    {'ref_id': 'nc',
     ...
     'guidance': _('1 – An existing problem/ challenge/ users that UNICEF is tackling or servicing in a meaningful way'
...
MANAGER_SCORES = [
    {'ref_id': 'm_i',
     'name': _('Impact'),
     'text': _('Composite score based on Reach: Number of Children Impacted; Reach: Addressing Target Populations; '
